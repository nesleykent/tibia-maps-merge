...
const STRINGS = {
  en: {
    ...
    promptCopied: (url) => `Prompt copied for ${url}. Paste it into ChatGPT, then paste its answer into Coordinates below.`,
    promptCopyFailed: 'Could not reach the clipboard. Open the guide and copy the prompt from there.',
    promptOpened: (url) => `Opened ChatGPT with the prompt for ${url}. Paste its answer into Coordinates below. If it arrived empty, use Copy Prompt instead.`,
  ...
  'pt-BR': {
    ...
    promptCopied: (url) => `Prompt copiado para ${url}. Cole no ChatGPT e depois cole a resposta dele em Coordenadas abaixo.`,
    promptCopyFailed: 'Não foi possível acessar a área de transferência. Abra o guia e copie o prompt de lá.',
    promptOpened: (url) => `ChatGPT aberto com o prompt para ${url}. Cole a resposta dele em Coordenadas abaixo. Se chegou vazio, use Copiar Prompt.`,
