...
const STRINGS = {
  en: {
    ...
    promptCopied: 'Prompt copied -- paste it into ChatGPT or another assistant.',
    promptCopyFailed: 'Could not reach the clipboard. Open the guide and copy the prompt from there.',
    promptOpened: 'Opened ChatGPT with the prompt. If it arrives empty, use Copy Prompt and paste it.',
  ...
  'pt-BR': {
    ...
    promptCopied: 'Prompt copiado -- cole no ChatGPT ou em outro assistente.',
    promptCopyFailed: 'Não foi possível acessar a área de transferência. Abra o guia e copie o prompt de lá.',
    promptOpened: 'ChatGPT aberto com o prompt. Se chegar vazio, use Copiar Prompt e cole.',
