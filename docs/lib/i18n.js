...
const STRINGS = {
  en: {
    ...
    assistantOpens: 'Copies the source-backed prompt and opens a new tab',
    ...
    promptOpened: (name, url) => `Copied the source-backed prompt for ${url} and opened ${name}. Paste the prompt there, then paste its answer into Coordinates below.`,
  ...
  'pt-BR': {
    ...
    assistantOpens: 'Copia o prompt com a fonte e abre uma nova aba',
    ...
    promptOpened: (name, url) => `Prompt com a fonte de ${url} copiado e ${name} aberto. Cole o prompt lá e depois cole a resposta em Coordenadas abaixo.`,
