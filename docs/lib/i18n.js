...
const STRINGS = {
  en: {
    ...
    extractNeedsMarkers: 'Load your marker file above to preview exactly what Extract Own will keep.',
    ...
    cancelAction: 'Cancel',
    undoAction: 'Undo',
    markDeleted: (label) => `Removed "${label || 'marker'}".`,
    marksDeletedCount: (n) => `Removed ${localeNumber(n, 'en')} mark(s).`,
    selectedCount: (n) => `${localeNumber(n, 'en')} selected`,
    selectRowLabel: (coordinates) => `Select mark at ${coordinates}`,
    editXLabel: 'X',
    editYLabel: 'Y',
    editZLabel: 'Z (floor)',
    editLabelLabel: 'Label',
    markIconFieldLabel: 'Marker icon',
  ...
  'pt-BR': {
    ...
    undoAction: 'Desfazer',
    markDeleted: (label) => `"${label || 'marcação'}" removida.`,
    marksDeletedCount: (n) => `${localeNumber(n, 'pt-BR')} marcação(ões) removida(s).`,
    selectedCount: (n) => `${localeNumber(n, 'pt-BR')} selecionada(s)`,
    selectRowLabel: (coordinates) => `Selecionar marcação em ${coordinates}`,
    editXLabel: 'X',
    editYLabel: 'Y',
    editZLabel: 'Z (andar)',
    editLabelLabel: 'Rótulo',
    markIconFieldLabel: 'Ícone da marcação',
