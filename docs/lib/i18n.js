...
const STRINGS = {
  en: {
    ...
    labelAdded: 'New markers added',
    labelReplaced: 'Yours replaced community markers',
    labelIdentical: 'Identical, skipped',
    labelConflicts: 'Of those, real conflicts',
    ...
    logAdded: 'Markers added (new coordinates)',
    logReplaced: 'Your markers that replaced community markers',
    logIdentical: 'Identical markers skipped (no real change)',
    logConflicts: 'Total conflicts detected',
  ...
  'pt-BR': {
    ...
    labelAdded: 'Novas marcações adicionadas',
    labelReplaced: 'Suas substituíram as da comunidade',
    labelIdentical: 'Idênticas, ignoradas',
    labelConflicts: 'Dessas, conflitos reais',
    ...
    logAdded: 'Marcações adicionadas (coordenadas novas)',
    logReplaced: 'Suas marcações que substituíram as da comunidade',
    logIdentical: 'Marcações idênticas ignoradas (sem mudança real)',
    logConflicts: 'Total de conflitos detectados',
